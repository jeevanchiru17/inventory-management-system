				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Phone </label>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="vendorDetailsVendorDistrict">Districts</label>
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="customerDetailsCustomerDistrict">Districts</label>
